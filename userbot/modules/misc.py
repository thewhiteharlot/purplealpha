...
async def reedme(event):
    await event.edit(
        ...
        "\n[Arquivo Readme do purplealpha](https://github.com/thewhiteharlot/purplealpha/blob/purplealpha/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Clique aqui](https://github.com/thewhiteharlot/purplealpha) para abrir o repositório do purplealpha."
    )
